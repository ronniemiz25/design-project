                        ...
                        <div className="row">
                            <div className="col-lg-6 overflow-hidden">
                                <div className="intro_col prime">
                                    <img src="public/images/ai-solutions-bg.webp" alt="" className="img-fluid" />
                                ...
                                <div className="row g-4">
                                    <div className="col-lg-12 overflow-hidden">
                                        <div className="intro_col secondary">
                                            <img src="public/images/successfull-projects-bg.webp" alt="" className="img-fluid" />
                                            <div className="overlay">
                                                <h3>70+</h3>
                                    ...
                                    <div className="col-lg-6 overflow-hidden">
                                        <div className="intro_col ">
                                            <img src="public/images/futuricstic-portrait-bg.webp" alt="" className="img-fluid" />
                                        </div>
                                    </div>
                                    <div className="col-lg-6 overflow-hidden">
                                        <div className="intro_col secondary">
                                            <img src="public/images/years-experience-bg.webp" alt="" className="img-fluid" />
                                            <div className="overlay">
                                                <h3>10+</h3>
