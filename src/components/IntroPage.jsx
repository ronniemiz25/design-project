                        ...
                        <div className="row">
                            <div className="col-lg-6 overflow-hidden">
                                <div className="intro_col prime">
                                    <img src="src/assets/ai-solutions-bg.webp" alt="" className="img-fluid" />
                                ...
                                <div className="row g-4">
                                    <div className="col-lg-12 overflow-hidden">
                                        <div className="intro_col secondary">
                                            <img src="src/assets/successfull-projects-bg.webp" alt="" className="img-fluid" />
                                            <div className="overlay">
                                                <h3>70+</h3>
                                    ...
                                    <div className="col-lg-6 overflow-hidden">
                                        <div className="intro_col ">
                                            <img src="src/assets/futuricstic-portrait-bg.webp" alt="" className="img-fluid" />
                                        </div>
                                    </div>
                                    <div className="col-lg-6 overflow-hidden">
                                        <div className="intro_col secondary">
                                            <img src="src/assets/years-experience-bg.webp" alt="" className="img-fluid" />
                                            <div className="overlay">
                                                <h3>10+</h3>
                        ...
                        <div className="row g-0">
                            <div className="col-lg-4 bordcol">
                                <div className="serv_col">
                                    <img src="src/assets/design.webp" alt="" className="img-fluid"/>
                                    <h3>Design</h3>
                            ...
                            <div className="col-lg-4 bordcol">
                                <div className="serv_col">
                                    <img src="src/assets/webdev.webp" alt="" className="img-fluid"/>
                                    <h3>WebDev</h3>
                            ...
                            <div className="col-lg-4 bordcol">
                                <div className="serv_col">
                                    <img src="src/assets/support.webp" alt="" className="img-fluid"/>
                                    <h3>Support</h3>
